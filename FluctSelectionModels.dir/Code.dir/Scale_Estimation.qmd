...
From the above, the mean phenotype is 1/2 the number of loci. Additive variance is 1/3 the number of loci. Because h2 = VA/VP, VP = VA/h2. So we should alter the scaling to be:
...
> Density distribution of adjusted phenotype values across loci counts related loci numbers and different heritability levels.
