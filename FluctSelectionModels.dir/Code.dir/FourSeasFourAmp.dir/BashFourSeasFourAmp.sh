...
echo -e "=== Beginning of SLiM run with different QTLs > $(date) ===">>../../Output.dir/FourSeasFourAmp.dir/FourSeasFourAmp${SLURM_JOBID}_${SLURM_ARRAY_TASK_ID}.log
output="/storage/hpc/group/kinglab/etb68/evogen-sims/ET_Yeast/Output.dir/FourSeasFourAmp.dir/genome5_100_0.5.csv"
if [[ ! -f "$output" ]]
then
...
do
  ...
  do
	...
	{
	 slim -d seed=$seed -d repl=$repl -d loci=$loci -d region=$region -d h=$h FourSeasFourAmp.slim
        } & 
      done
    #done
  done
...
echo "=== Finished! End of SLiM QTLs fluctuating 4 sinusoidal run > $(date). Total runtime: $total_runtime seconds ===" >>../../Output.dir/FourSeasFourAmp.dir/FourSeasFourAmp${SLURM_JOBID}_${SLURM_ARRAY_TASK_ID}.log
