...
# 
# install.packages(
#   c("patchwork", "cowplot", "ggplot2", "doParallel", "stringi", "stringr", "tidyr", "forcats", "purrr"),
#   lib   = local_lib,
...
required_packages <- c(
  "patchwork", "cowplot", "ggplot2", "doParallel",
  "stringi", "stringr", "tidyr", "forcats", "purrr", "furrr","parallel", "foreach","dplyr"
)

missing_packages <- required_packages[!required_packages %in% installed.packages()[,"Package"]]
if (length(missing_packages) > 0) {
  install.packages(missing_packages, lib = local_lib, repos = "https://cloud.r-project.org")
}
...
###...................................#######
  ...
  num_cores_to_use <- max(1, num_cores - 32)  # check the cores before
...
```{r, warning=FALSE, fig.width = 25, fig.height = 30, dpi = 1200, echo=FALSE}
