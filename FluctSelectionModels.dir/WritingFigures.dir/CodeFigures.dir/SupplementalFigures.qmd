...
GradII_Poly_70_AF <- gradIIeQualDplots_AF[[70]] +
  ggtitle("Gradual II Equal D Poligenic (70 loci)") +
  theme(
    plot.title = element_text(
      hjust = 0.5,         
      size = 70, 
...
GradII_Poly_300_AF <- gradIIeQualDplots_AF[[300]] +
  ggtitle("Gradual II Equal D Poligenic (300 loci)") +
  theme(
    plot.title = element_text(
      hjust = 0.5,         
      size = 70, 
...
GradII_Poly_70_SA <- result[[3]] +
  ggtitle("Spectral Density: Gradual II Equal D Polygenic (70 loci)") +
  theme(
    plot.title = element_text(
      hjust = 0.5,         
      size = 70, 
...
GradII_GradII_Poly_300_SA <- result[[5]] +
  ggtitle("Spectral Density: Gradual II Equal D Polygenic (300 loci)") +
  theme(
    plot.title = element_text(
      hjust = 0.5,         
      size = 70, 
...
```{r, warning=FALSE, fig.width = 15, fig.height = 7, echo=FALSE, message=FALSE}
#| label: GradII_Single_Locus_AllReplicates
#| fig-cap: "SSI 3.1.1. Single locus 30 replicates allele frequency dynamics for gradual four unequal seasons selection model, showing all parameter interactions. The highlighted line indicates the mean allele frequency for each generation."
#| fig-pos: "H"
#| 
...
GradII_UnequalD_Poly_70_AF <- gradIIplots_AF[[70]] +
  ggtitle("Gradual II Unequal D Poligenic (70 loci)") +
  theme(
    plot.title = element_text(
      hjust = 0.5,         
      size = 70, 
...
GradII_UnequalD_Poly_300_AF <- gradIIplots_AF[[300]] +
  ggtitle("Gradual II Unequal D Poligenic (300 loci)") +
  theme(
    plot.title = element_text(
      hjust = 0.5,         
      size = 70, 
...
GradII_UnequalD_Poly_70_SA <- result[[3]] +
  ggtitle("Spectral Density: Gradual II Unequal D Polygenic (70 loci)") +
  theme(
    plot.title = element_text(
      hjust = 0.5,         
      size = 70, 
...
GradII_GradII_UnequalD_Poly_300_SA <- result[[5]] +
  ggtitle("Spectral Density: Gradual II Unequal D Polygenic (300 loci)") +
  theme(
    plot.title = element_text(
      hjust = 0.5,         
      size = 70, 
...
#| fig-cap: "SI 4.2. Mean population phenotypic plot across 30 replicates (each line represents a single replicate) for Null selection, showing parameter interactions."
#| fig-pos: "H"
dirpath <- "../../Output.dir/NS.dir/"
...
#| fig-cap: "SI 4.3. Spectral density across 30 replicates for all genetic architecture under Null selection model. The density plots do not show any peak as selection is purely driven by random drift."
#| fig-pos: "H"
#| 
dirpath <- "../../Output.dir/NS.dir/"
pattern <- "^genome\\d+_n(1|10|300)_H0\\.(8)(SD(1|2|4))?(Gen(10|20|30))?\\.csv$" 
