...
#SBATCH -A kinglab
#SBATCH -J CS_par4.slim 
#SBATCH -c 4
#SBATCH -t 2-00:00:00
#SBATCH --mem 120G
#SBATCH --array=0-4
#SBATCH -o ../../../../output.dir/Selection_Models/WF.dir/CS.dir/CS_par4.slim-%A_%a.log
#SBATCH -e ../../../../output.dir/Selection_Models/WF.dir/CS.dir/CS_par4-%A_%a.err
##########SCIENCE FOLLOWS HERE ########################

#module load SLiM

echo -e "=== Bigining of SLiM run with different QTLs > $(date) ===" >> ../../../../output.dir/Selection_Models/WF.dir/CS.dir/CS_par4.slim-$SLURM_JOBID.log
...
do
  ...
  do
	...
	region=${loci_to_regions[$loci]}
       	...
       	slim -d seed=$seed -d repl=$repl -d loci=$loci -d region=$region -d h=$h -d gen=$gen -d rang=$rang -d SD=$SD CS_Par4.slim
wait

else
  echo "All is well, Boss.  The ${output} file is there."
fi
echo "=== Fini finito! End of SLiM QTLs Constant Selection run >" $(date) >> ../../../../output.dir/Selection_Models/WF.dir/CS.dir/CS_par4.slim-$SLURM_JOBID.log
