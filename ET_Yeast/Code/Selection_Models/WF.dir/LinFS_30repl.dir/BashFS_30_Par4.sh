...
#SBATCH -p BioCompute,hpc4,Lewis
#SBATCH --qos biolong 
#SBATCH -A deckerlab
...
#SBATCH -t 4-00:00:00
#SBATCH --mem 120G
#SBATCH -o ../../../../output.dir/Selection_Models/WF.dir/LinFS_30repl.dir/FS_30_par4-%j.log
#SBATCH -e ../../../../output.dir/Selection_Models/WF.dir/LinFS_30repl.dir/FS_30_par4-%j.err
##########SCIENCE FOLLOWS HERE ########################

#module load SLiM
echo -e "=== Beginning of SLiM run with different QTLs > $(date) ===" >> ../../../../output.dir/Selection_Models/WF.dir/LinFS_30repl.dir/FS_30_par4-$SLURM_JOBID.log

output="/storage/hpc/group/kinglab/etb68/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS_30repl.dir/genome5_100_0.5.csv"
if [[ ! -f "$output" ]]
then
...
do
  ...
  do
    ...
    do
	  ...
	  slim -d seed=$seed -d repl=$repl -d loci=$loci -d region=$region -d h=$h -d gen=$gen -d rang=$rang -d SD=$SD FS_30_Par4.slim
        done
      done
    done
  done
...
echo "=== Fini finito! End of SLiM QTLs Constant Selection run >" $(date) >> ../../../../output.dir/Selection_Models/WF.dir/LinFS_30repl.dir/FS_30_par4-$SLURM_JOBID.log
