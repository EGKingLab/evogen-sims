...
#SBATCH -A deckerlab
#SBATCH -J FS_par4.slim 
#SBATCH -c 4
#SBATCH -t 2-00:00:00
#SBATCH --mem 120G
#SBATCH --array=0-4
#SBATCH -o ../../../../output.dir/Selection_Models/WF.dir/LinFS.dir/FS_par4-%A%a.log
#SBATCH -e ../../../../output.dir/Selection_Models/WF.dir/LinFS.dir/FS_par4-%A%a.err
