...
echo -e "=== Beginning of SLiM run with different QTLs > $(date) ===">>../../../../output.dir/Selection_Models/WF.dir/SinFS.dir/FS_OptSin${SLURM_JOBID}_${SLURM_ARRAY_TASK_ID}.log
...
echo "=== Finished! End of SLiM QTLs fluctuating 2 sinusoidal run > $(date). Total runtime: $total_runtime seconds ===" >>../../../../output.dir/Selection_Models/WF.dir/SinFS.dir/FS_OptSin${SLURM_JOBID}_${SLURM_ARRAY_TASK_ID}.log
