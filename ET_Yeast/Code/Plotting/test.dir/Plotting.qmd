...
## Plotting Allele Frequency Over Generation and Phenotype Information
...
```{r}
#| echo: false
my_plots <- function(df, mygenomefile){
  ...
  ggsave(file.path(mypath, paste0(mygenomefile, "Freq_plot.png")), Freq_plot, width = 6, height = 4, dpi = 300)
  ggsave(file.path(mypath, paste0(mygenomefile, "Effect_plot.png")), Effect_plot, width = 6, height = 4, dpi = 300)
}

#mygenomefiles <- c("../../../output.dir/Selection_Models/genome1_70_0.5.csv", "../../../output.dir/Selection_Models/genome2_70_0.5.csv", "../../../output.dir/Selection_Models/genome3_70_0.5.csv")
mygenomefiles <- list.files(path = "/home/etb68/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/", pattern = "^genome.*\\.csv$", full.names = TRUE)
...
walk2(dfs, mygenomefiles, my_plots, mypath = mypath)
...
mon_plots <- function(data, myphenofile, mypath){
  ...
  ggsave(file.path(mypath, paste0(myphenofile, "Pheno_plots.png")), Pheno_Fit, width = 6, height = 4, dpi = 300)
 
  # ggsave(paste0(myphenofile, "Pheno_Fit.png"), Pheno_Fit_plot, width = 6, height = 4, dpi = 300)
}
mypath <- "/home/etb68/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/CSCP_Plots.dir"
myphenofiles <- list.files(path = "/home/etb68/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/", pattern = "^MeanPhenotypes.*\\.csv$", full.names = TRUE)
