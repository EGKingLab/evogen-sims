...
z %>% ggplot(aes(x,Y))+
  ...
  annotate("text", x = 22, y = max(Y)/1.2, label = "infinitesimal model", fontface = "bold") +  # Add this line
  labs(x = "Loci", y = "Effect")+
  theme_set(theme_cowplot())+
...
p2 <- ggplot()+
  ...
  annotate("text", x = 55, y = mu_pheno, 
           label = "Mean Phenotype", 
           size = 3.5, vjust = 0.1, hjust = 0, 
...
```{r}
pheno <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/MeanPhenotypes1_n100_H0.5SD1Gen10.csv") %>% 
...
```{r}
geno <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.1SD1Gen30.csv") %>% 
...
mono1 <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n100_H0.8SD3Gen10.csv")
mono2 <-  read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/SinFS.dir/genome1_n100_H0.8SD3Gen10.csv")
```
...
```{r}
#dirpath <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/"
Oligo1 <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.1SD1Gen10.csv")
Oligo2 <-  read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/SinFS.dir/genome1_n70_H0.1SD1Gen10.csv")
```
...
```{r}
Heri1 <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.1SD2Gen10.csv")
Herit2 <-  read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.8SD2Gen10.csv")
```
...
```{r, warning=FALSE, fig.width = 8, fig.height = 4}
file1 <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.1SD1Gen10.csv"
file2 <-  "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.1SD3Gen10.csv"

# Example usage of the function with multiple files and different descriptors
 file_paths <- c(file1, file2)
 descriptors <- c("Selection Strength = 1", "Selection Strength = 2")
...
```{r, warning=FALSE, fig.width = 8, fig.height = 4}
file1 <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.1SD2Gen10.csv"
file2 <-  "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.1SD2Gen30.csv"
...
```{r, warning=FALSE, fig.width = 8, fig.height = 4}
file1 <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.1SD1Gen10.csv"
file2 <-  "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.8SD4Gen30.csv"
...
Mono <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n1_H0.1SD1Gen20.csv")
Oligo <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n10_H0.1SD1Gen20.csv")
Poly<- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n70_H0.1SD1Gen20.csv")
...
freqplot <- Genome_dataset %>% 
  ...
  geom_line(linewidth = 0.5, alpha = 0.5) + #, color = "grey"
  facet_wrap(~Selection) +
  theme_cowplot() +
  theme(legend.position = "none",
...
```{r,  warning=FALSE, fig.width = 8, fig.height = 4}
mono1 <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n70_H0.5SD4Gen20.csv")
mono2 <-  read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/SinFS.dir/genome1_n70_H0.5SD4Gen20.csv")
mono3 <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/SinFSGen.dir/genome1_n70_H0.5SD4.csv")
...
```{r, warning=FALSE, fig.width = 8, fig.height = 4}
file1 <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/NS.dir/genome1_n70_H0.5.csv"
file2 <-  "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/SinFSGen.dir/genome1_n70_H0.5SD4.csv"
...
pattern ="^genome[1-3]_n10_H0\\.(1|8)(SD(1|4))?(Gen(10|30))?\\.csv$"
...
geno <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/genome1_n70_H0.5SD4Gen30.csv") %>% 
  filter(Generation <= 500)
pheno <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/MeanPhenotypes1_n100_H0.5SD4Gen30.csv")%>% 
  filter(Generation <= 500)
  ...
  for(file in files){
    ...
    data <- read.csv(file, header = TRUE) %>% 
      mutate(herit = herit, loci = loci, sd = sd,
           ...
           loci_gen = paste("loci = ", loci," ", "gen = ", gen, sep = ""),
           Fitness = exp(-(1/Phenotype) * (Phenotype - Optimum)^2),
  ...
  if (plot_type == "loci_gen") {
    ...
    for (loci_gen_val in unique_loci_gens) {
      ...
      p <- ggplot(loci_gen_data, aes(x = Generation, y = Phenotype)) +
        geom_histogram(aes(group = Generation, fill = Optimum, color = Fitness), size = 1, varwidth = TRUE, alpha = 0.5) +  
...
```{r}
dirpath <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/"
pattern <- "^MeanPhenotypes\\d+_n300_H0\\.(1)(SD(1))?(Gen(10))?\\.csv$"
result <- process_files(dirpath, pattern, "loci_gen")
...
```{r}
ph1 <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/MeanPhenotypes1_n10_H0.1SD1Gen10.csv")
ph11 <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/MeanPhenotypes1_n10_H0.1SD2Gen10.csv")
ph2 <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/MeanPhenotypes1_n10_H0.1SD3Gen10.csv")
ph22 <- read.csv("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/MeanPhenotypes1_n10_H0.1SD4Gen10.csv")
