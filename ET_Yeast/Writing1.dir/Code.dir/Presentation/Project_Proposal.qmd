...
z %>% ggplot(aes(x,Y))+
  ...
  annotate("text", x = 55, y = max(Y)/1.5, label = "infinitesimal model", fontface = "bold", size = 10) +  #  Add this line
...
y2 <- 2 * sin(x + pi)       # Second signal, shifted by π (opposite phase)
