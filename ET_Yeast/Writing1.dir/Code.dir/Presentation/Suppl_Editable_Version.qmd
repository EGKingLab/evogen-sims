...
> For the allele frequencies, I will in some cases use ribbon/violin to show changes across replicates. Then I will use a single replicate to track each locus.
...
#| label: Monogenic_Allele_Frequency
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(plots[1], plots[2], plots[3]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Oligogenic_Allele_Frequency
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(plots[4], plots[5], plots[6]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Polygenic_70_Allele_Frequency
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(plots[13], plots[14], plots[15]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Polygenic_100_Allele_Frequency
library(cowplot)
labels <- LETTERS[1:3]
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Polygenic_300_Allele_Frequency
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(plots[10], plots[11], plots[12]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Polygenic_100_Phenotypes
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(plots[7], plots[8], plots[9]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Polygenic_300_Phenotypes
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(plots[10], plots[11], plots[12]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Monogenic_Spectral_Analysis
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(result[1], result[2], result[3]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Oligogenic_Spectral_Analysis
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(result[4], result[5], result[6]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Polygenic_70_Spectral_Analysis
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(result[10], result[11], result[12]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Polygenic_100_Spectral_Analysis
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(result[7], result[8], result[9]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
```{r, fig.height = 30, fig.width = 20, echo=FALSE}
#| label: Polygenic_300_Spectral_Analysis
library(cowplot)
labels <- LETTERS[1:3]
plot_grid(plotlist = c(result[13], result[14], result[15]), ncol = 1, labels = labels, label_size = 60, label_colour = "red")
```
...
## 2. Gradual polygenic models

```{r, echo=FALSE}
# dirpath <- "../../../output.dir/Selection_Models/WF.dir/SinFS.dir/"
# pattern <- "^genome12"
# result2 <- run_fft_analysis(dirpath, pattern, spectrum_span = 2)
```
