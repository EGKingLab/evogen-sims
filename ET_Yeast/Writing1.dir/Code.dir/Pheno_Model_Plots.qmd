...
file_path <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/CS.dir/MeanPhenotypes1_n1_H0.8SD1.csv"

pheno_file <- read.csv(file_path) %>% 
  mutate(Optimum = Optimum - 100, Phenotype = Phenotype - 100)
...
```{r, echo=FALSE, results='hold', fig.width = 16, fig.height = 8}
file_path <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/SinFS.dir/MeanPhenotypes1_n100_H0.8SD1Gen10.csv"
...
pheno_file <- pheno_file %>% filter(Generation < 200)
...
genome_files <- list.files("~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/NS.dir/", pattern = "^MeanPhenotypes15", full.names = TRUE)
...
for(locus in loci){
  ...
  #geom_line(aes(y = Optimum), color = "darkred", linewidth = 0.2) +
