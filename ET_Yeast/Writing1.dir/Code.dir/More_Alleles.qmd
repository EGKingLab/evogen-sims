...
pattern <- "^genome10_n(1|10|100|300)_H(0\\.1)\\.csv$"
...
pattern <- "^genome10_n(1|10|100|300)_H(0\\.1)SD(1|4)Gen(10)\\.csv$"
plot_result <- gen_plotting_function(dirpath, pattern)
print(plot_result)
...
```{r, warning=FALSE, fig.width = 16, fig.height = 8, echo=FALSE, message=FALSE}
dirpath <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/"
pattern <- "^genome10_n(1|10|100|300)_H(0\\.1|0\\.8)SD(1)Gen(10)\\.csv$"
plot_result <- gen_plotting_function(dirpath, pattern)
print(plot_result)
```
...
```{r, warning=FALSE, fig.width = 16, fig.height = 8, echo=FALSE, message=FALSE}
dirpath <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/"
pattern <- "^genome10_n(1|10|100|300)_H(0\\.1)SD(1)Gen(10|30)\\.csv$"
plot_result <- gen_plotting_function(dirpath, pattern)
print(plot_result)
```
...
```{r, warning=FALSE, fig.width = 16, fig.height = 8, echo=FALSE, message=FALSE}
dirpath <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/LinFS.dir/"
pattern <- "^genome10_n(1|10|100|300)_H(0\\.8|0\\.1)SD(4)Gen(30)\\.csv$"
plot_result <- gen_plotting_function(dirpath, pattern)
print(plot_result)
```
...
pattern <- "^genome10_n(1|10|100|300)_H(0\\.1|0\\.8)SD(1|4)Gen(10|30)\\.csv$"
plot_result <- gen_plotting_function(dirpath, pattern)
print(plot_result)
```
...
pattern <- "^genome10_n(1|10|100|300)_H(0\\.1|0\\.8)SD(1|4)\\.csv$"
plot_result <- gen_plotting_function(dirpath, pattern)
print(plot_result)
...
```{r, warning=FALSE, fig.width = 16, fig.height = 8, echo=FALSE, message=FALSE}
dirpath <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/SinFSGen.dir/"
pattern <- "^genome10_n(1|10|100|300)_H(0\\.1)SD(1|4)\\.csv$"
plot_result <- gen_plotting_function(dirpath, pattern)
print(plot_result)
...
```{r, warning=FALSE, fig.width = 16, fig.height = 8, echo=FALSE, message=FALSE}
dirpath <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/SinFSGen.dir/"
pattern <- "^genome10_n(1|10|100|300)_H(0\\.1|0\\.8)SD(1)\\.csv$"
plot_result <- gen_plotting_function(dirpath, pattern)
print(plot_result)
```
...
```{r, warning=FALSE, fig.width = 16, fig.height = 8, echo=FALSE, message=FALSE}
dirpath <- "~/YeastProj.dir/evogen-sims/ET_Yeast/output.dir/Selection_Models/WF.dir/SinFSGen.dir/"
pattern <- "^genome10_n(1|10|100|300)_H(0\\.8)SD(4)\\.csv$"
plot_result <- gen_plotting_function(dirpath, pattern)
print(plot_result)
```
